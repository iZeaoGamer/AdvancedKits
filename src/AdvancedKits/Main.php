...
class Main extends PluginBase{
    ...
    public function onEnable(){
        ...
        if(Enchantment::getEnchantmentByName("KNOCKBACK") === null){
            Enchantment::registerEnchantment(new Enchantment(Enchantment::KNOCKBACK, "%enchantment.knockback", Enchantment::RARITY_COMMON, Enchantment::SLOT_NONE));
        }
        if(Enchantment::getEnchantmentByName("SHARPNESS") === null){
            Enchantment::registerEnchantment(new Enchantment(Enchantment::SHARPNESS, "%enchantment.sharpness", Enchantment::RARITY_COMMON, Enchantment::SLOT_NONE));
        }
